...
**[MitchelNLP-v0.2.21-windows-x64.exe](https://github.com/jmb-sagiwork/NLP-Mitchel/releases/download/v0.2.21/MitchelNLP-v0.2.21-windows-x64.exe)** — the complete attended application in one executable. Download and double-click to run.
...
```powershell
.\MitchelNLP-v0.2.21-windows-x64.exe --selftest
```
